...
export function LiveTrading({ language }: Props) {
  ...
  const dailyGuardDetail = dailyGuard
    ? dailyGuard.blocked
      ? (pt
          ? 'BLOQUEADO • perda realizada do bot ' + Number(dailyGuard.botLossPercent || dailyGuard.lossPercent || 0).toFixed(2) + '% / limite ' + Number(dailyGuard.limitPercent || 0).toFixed(2) + '%'
          : 'BLOCKED • bot realized loss ' + Number(dailyGuard.botLossPercent || dailyGuard.lossPercent || 0).toFixed(2) + '% / limit ' + Number(dailyGuard.limitPercent || 0).toFixed(2) + '%')
      : (pt
          ? 'OK • perda realizada do bot ' + Number(dailyGuard.botLossPercent || dailyGuard.lossPercent || 0).toFixed(2) + '% / limite ' + Number(dailyGuard.limitPercent || 0).toFixed(2) + '%'
          : 'OK • bot realized loss ' + Number(dailyGuard.botLossPercent || dailyGuard.lossPercent || 0).toFixed(2) + '% / limit ' + Number(dailyGuard.limitPercent || 0).toFixed(2) + '%')
 ...
 + Number(dailyGuard.realizedBotPnlUsd || 0).toFixed(2)}</strong>
              </div>
              <div>
 ...
 + Number(dailyGuard.realizedBotLossUsd || 0).toFixed(2)}</strong>
              </div>
              <div>
                <small>{pt ? 'Perda do bot %' : 'Bot loss %'}</small>
                <strong>{Number(dailyGuard.botLossPercent || dailyGuard.lossPercent || 0).toFixed(2) + '%'}</strong>
              </div>
              <div>
 ...
 + Number(dailyGuard.currentEquityUsd || 0).toFixed(2) +
                  ' • ' + Number(dailyGuard.marketDrawdownPercent || 0).toFixed(2) + '%'}
              </span>
